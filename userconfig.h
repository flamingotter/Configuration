...
// -- Project -------------------------------------
#define PROJECT                "sonoff7"          // PROJECT is used as the default topic delimiter and OTA file name
...
#define STA_PASS1              "pwd"  // [Password1] Wifi password
...
#else
  #define MQTT_HOST            "10.0.10.10"          // [MqttHost]
...
#define APP_LEDSTATE           LED_OFF         // [LedState] Function of led (LED_OFF, LED_POWER, LED_MQTTSUB, LED_POWER_MQTTSUB, LED_MQTTPUB, LED_POWER_MQTTPUB, LED_MQTT, LED_POWER_MQTT)
